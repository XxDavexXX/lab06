...
<div class="form-structor">
	<div class="signup">
		<h2 class="form-title" id="signup">Editar Alumno</h2>
        <form action="update_alumnos.php" method="post">
    ...
    if(isset($_GET['x'])) {
        ...
        if ($res) {
                while($row = mysqli_fetch_assoc($res)) {
                    echo '<input type="hidden" class="input fav" name="cod" value="'.$row["codigo"].'" />';
                    echo '<input type="text" class="input fav" name="nombres" value="'.$row["nombres"].'" />';
                    echo '<input type="text" class="input fav" name="apellidos" value="'.$row["apellidos"].'" />';
                    echo '<input type="text" class="input fav" name="dni" value="'.$row["dni"].'" />';
                    echo '<input type="text" class="input fav" name="direcc" value="'.$row["direccion"].'" />';
                }
          } else {
